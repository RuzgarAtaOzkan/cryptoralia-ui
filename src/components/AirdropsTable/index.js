...
// STYLES
import styles from './AirdropsTable.module.scss';

function AirdropsTable({ data, title = '<h1>Crypto Airdrops</h1>', desc = 'You can earn rewards by getting crypto airdrops.' }) {
